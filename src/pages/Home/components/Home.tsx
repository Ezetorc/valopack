...
export default function Home () {
  ...
  const { setSelectorVisible, selectorVisible } = useUser()
  ...
  useEffect(() => console.log(selectorVisible), [selectorVisible])

  return (
    <section className='w-full min-h-[100dvh]'>
      <Header />

      <article className='grid grid-cols-[1.3fr_1fr] grid-rows-[1fr_1fr] place-items-center gap-[4%] p-[3%] w-full min-h-[100dvh] pt-[20vh]'>
        <SectionLink
          to={paths.play}
          text={texts.play}
          image={vyzeImage}
